...
QT_MOC_LITERAL(3, 29, 27), // "PrecheckStateMachine::State"
QT_MOC_LITERAL(4, 57, 5), // "state"
QT_MOC_LITERAL(5, 63, 28), // "PrecheckStateMachine::Status"
QT_MOC_LITERAL(6, 92, 6), // "status"
QT_MOC_LITERAL(7, 99, 7), // "message"
QT_MOC_LITERAL(8, 107, 15), // "receiveFromPort"
QT_MOC_LITERAL(9, 123, 7) // "content"

    },
    "PrecheckThread\0sendToWindow\0\0"
...
void PrecheckThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendToWindow((*reinterpret_cast< PrecheckStateMachine::State(*)>(_a[1])),(*reinterpret_cast< PrecheckStateMachine::Status(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        ...
        {
            using _t = void (PrecheckThread::*)(PrecheckStateMachine::State , PrecheckStateMachine::Status , QString );
...
// SIGNAL 0
void PrecheckThread::sendToWindow(PrecheckStateMachine::State _t1, PrecheckStateMachine::Status _t2, QString _t3)
{
